...
const ManageAccounts = (props) => {
  ...
  const handleUpdate = (e) => {
    ...
    if (!editedPassword && !editedEmail) {
      setError(
        "Invalid account update. Please choose an information to update."
      );
      return;
    }
    ...
    if (userIndex !== -1) {
      /*irereturn ang -1 kung hindi magkakaroon ng match yung username, meaning non-existent sa array yung username*/
  ...
  return (
    <div>
      ...
      <div className="userInfoContainer">
        <p className="userInfoHeader">Personal Information</p>
        <p className="userInfo">Surname: {user.surname}</p>
        <p className="userInfo">First Name: {user.firstName}</p>
        <p className="userInfo">Middle Name: {user.middleName}</p>
      </div>
      ...
      <form className="manageAccountContainer" onSubmit={handleUpdate}>
        ...
        <div>
          ...
          <div className="changeEmailContainer">
            ...
            <p className="displayCurrentEmail">
